namespace famiLYNX.Migrations {
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<famiLYNX.Models.DataContext> {
        public Configuration() {
            AutomaticMigrationsEnabled = false;
        }

        protected override void Seed(famiLYNX.Models.DataContext context) {
